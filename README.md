...
2. Abra [`supabase/functions/create-client/index.ts`](supabase/functions/create-client/index.ts) deste repositório, copie todo o conteúdo e cole no editor do Supabase.
3. Clique em **Deploy**.
...
vendor/                             → bibliotecas usadas pela página (React, Supabase JS, fontes) — não precisa mexer
supabase/schema.sql                 → tabelas, permissões e dados iniciais do banco
supabase/functions/create-client/   → função que cria o login de cada cliente novo
```
